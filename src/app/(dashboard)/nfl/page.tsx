    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <div className="mb-8">
        <div className="flex items-center space-x-3 mb-2">
          ...
          <h1 className="text-3xl font-bold text-slate-900 dark:text-white">NFL</h1>
        </div>
        <p className="text-slate-600 dark:text-slate-400">
          Live scores, standings, and team stats for the National Football League
        </p>
      </div>

      {/* Live Scores Section */}
      <section className="mb-8">
        <LiveScores sport="nfl" />
      </section>
      ...
      <div className="mt-12 space-y-6">
        ...
        <div className="text-center py-8">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-2xl mx-auto">
            ...
            <div className="bg-white dark:bg-slate-800 p-4 rounded-lg border">
              <h4 className="font-medium mb-1">Playoffs</h4>
              <p className="text-sm text-slate-600 dark:text-slate-400">
                Playoff bracket and schedules
              </p>
            </div>
          </div>
        </div>
